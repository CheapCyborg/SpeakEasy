...
async def record_audio(input_device, status_queue=None):
    global is_recording, recording_started  # Move this inside the function
    ...
    RATE = 44100
    CHUNK = 1024
    MIN_LENGTH = 0.1  # Minimum recording length in seconds
    ...
    try:
        ...
        # Check if the recorded audio is at least MIN_LENGTH seconds long
        ...
        if status_queue:
            status_queue.put(f"Error recording audio: {str(e)}")
